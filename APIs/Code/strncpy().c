...
//Lỗi tràn bộ đệm (buffer overflow): khi bạn sao chép quá nhiều ký tự vào một chuỗi đích có kích thước nhỏ hơn, dẫn đến việc ghi đè lên các vùng nhớ liền kề, 
//gây ra các hậu quả không mong muốn như thay đổi giá trị của các biến, làm hỏng các con trỏ, hoặc thậm chí là thực thi mã độc.
...
// Lỗi tràn bộ đệm: khi bạn sao chép 10 ký tự từ chuỗi nguồn vào mảng đích, hàm strncpy() đã ghi đè lên vùng nhớ của biến x, dẫn đến việc giá trị của biến x bị thay đổi từ 100 thành 2188396. Nếu bạn sử dụng một trình biên dịch khác, hoặc thay đổi vị trí của các biến, bạn có thể nhận được kết quả khác nhau, nhưng đều cho thấy sự sai lệch của dữ liệu.
